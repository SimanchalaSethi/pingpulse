...
# Allow nodes to pull Secrets Manager values (for DB passwords)
...
resource "aws_eks_cluster" "main" {
  ...
  tags = merge(var.tags, { Name = "${var.project_name}-${var.environment}-eks" })
...
resource "aws_eks_node_group" "main" {
  ...
  tags = merge(var.tags, { Name = "${var.project_name}-${var.environment}-${each.key}" })
